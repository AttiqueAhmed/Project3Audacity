...
step_trainer_trusted_node1711741077684 = glueContext.getSink(path="s3://project3parent/step_trainer/trusted/", connection_type="s3", updateBehavior="LOG", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="step_trainer_trusted_node1711741077684")
step_trainer_trusted_node1711741077684.setCatalogInfo(catalogDatabase="project3",catalogTableName="step_trainer_trusted")
step_trainer_trusted_node1711741077684.setFormat("json")
step_trainer_trusted_node1711741077684.writeFrame(DropFields_node1711741237338)
job.commit()